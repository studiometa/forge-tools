...
`);
    ...
    console.log(`
${colors.bold("forge security-rules update")} - Update a security rule

${colors.bold("USAGE:")}
  forge security-rules update <rule_id> --server <server_id> --site <site_id> --name <name> [options]
...
${colors.bold("SUBCOMMANDS:")}
  ...
  update <id>         Update a security rule
