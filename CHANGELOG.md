...
- **CLI**: Fix site name resolution in `sites get` and `sites update` commands [[ecb99c0]]

[ecb99c0]: https://github.com/studiometa/forge-tools/commit/ecb99c0

## 0.4.1 - 2026.04.01

### Fixed

- **API**: Fix `SiteRepositorySchema` to allow null `provider`, `url`, `branch`, and `status` fields [[c4c4f63]]

[c4c4f63]: https://github.com/studiometa/forge-tools/commit/c4c4f63
